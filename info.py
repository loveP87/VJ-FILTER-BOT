...
PICS = (environ.get('PICS', 'https://files.catbox.moe/hh2kxw.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6284062003').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002320513216'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002245049995 -1002348231490').split()]  # For Multiple Id Use One Space Between Each.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 't.me/+fjVY9T__hx0wMmY9')
CHNL_LNK = environ.get('CHNL_LNK', 't.me/uygfuwgfugugfg')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 't.me/+K90TwSvypmAyZGY1') # Support Chat Link Without https:// or @
...
SHORTLINK_API = environ.get('SHORTLINK_API', '624e8f13c6f1a0e4e5eff5756b904be8945903f7')
